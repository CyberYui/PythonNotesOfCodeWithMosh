...
print("course:", course)  # 输出字符串
print("len(course):", len(course))  # 输出字符串的长度
print("course[0]:", course[0])  # 输出字符串的第一个字符
print("course[-1]:", course[-1])  # 输出字符串的最后一个字符
print("course[0:3]:", course[0:3])  # 输出字符串的前三个字符,结束索引不包含在内
print("course[0:]:", course[0:])  # 输出字符串的所有字符
print("course[:5]:", course[:5])  # 输出字符串的前五个字符
print("course[:]:", course[:])  # 输出字符串的所有字符
# 当后索引小于前索引时，输出一个空字符串
print("course[5:0]:", course[5:0])  # 输出一个空字符串
print("course[-1:5]:", course[-1:5])  # 输出一个空字符串

# \" 转义字符，表示一个双引号
# \' 转义字符，表示一个单引号
# \\ 转义字符，表示一个反斜杠
# \n 转义字符，表示一个换行符
# \t 转义字符，表示一个制表符，实际上就是个空格
course = "Python \nProgramming"
print(course)  # 输出字符串，包含换行符
...
print(full)  # 使用 f-string 格式化的字符串
full = f"{len(first)} {2 + 2}"  # 在 f-string 中使用表达式
print(full)  # 输出使用表达式的字符串

print("*" * 10)

# 在Python中任何一个内容都是对象，包括字符串。这意味着我们可以在字符串上调用方法。
course = "Python Programming"
course.upper()  # 将字符串转换为大写
print("course.upper():", course.upper())  # 输出转换后的字符串
print("course:", course)  # 输出原字符串，说明原字符串是不变的
course_capital = (
    course.capitalize()
)  # 将字符串的第一个字符转换为大写，其他字符转换为小写
print("course.capitalize():", course_capital)  # 输出转换后的字符串
print("course:", course)  # 输出原字符串，说明原字符串是不变的

course.lower()  # 将字符串转换为小写
print("course.lower():", course.lower())  # 输出转换后的字符串
print("course.title():", course.title())  # 将字符串的每个单词的首字母转换为大写

print("*" * 10)
course = "   Python Programming   "
print("course:", course)  # 输出原字符串，包含两端的空格
print("course.strip():", course.strip())  # 去除字符串两端的空格
print("course.lstrip():", course.lstrip())  # 去除字符串左侧的空格
print("course.rstrip():", course.rstrip())  # 去除字符串右侧的空格

print("course.find('pro'):", course.find("pro"))  # 查找字符串中第一个 "pro" 的索引
print(
    "course.find('Pro'):", course.find("Pro")
)  # 查找字符串中第一个 "Pro" 的索引，区分大小写
print(
    "course.replace('P', 'J'):", course.replace("P", "J")
)  # 将字符串中的 "P" 替换为 "J"
print("'Pro' in course:", "Pro" in course)  # 检查字符串中是否包含 "Pro"
# Find方法返回子字符串在字符串中第一次出现的位置索引，如果没有找到则返回 -1
# 而 in 操作符返回一个布尔值，表示子字符串是否存在于字符串中

print("'swift' not in course:", "swift" not in course)  # 检查字符串中是否不包含 "swift"
...
print("round(2.9):", round(2.9))  # 输出 3
print("abs(-2.9):", abs(-2.9))  # 输出 -2.9 的绝对值

math.ceil(2.9)  # 将 2.9 向上取整到最接近的整数
print("math.ceil(2.9):", math.ceil(2.9))  # 输出 3
math.floor(2.9)  # 将 2.9 向下取整到最接近的整数
print("math.floor(2.9):", math.floor(2.9))  # 输出 2
...
print('bool(""):', bool(""))  # 输出 False，因为空字符串是 Falsy 值
print('bool("False"):', bool("False"))  # 输出 True，因为非空字符串是 Truthy 值
print("bool(0):", bool(0))  # 输出 False，因为 0 是 Falsy 值
...
print("bool(True):", bool(True))  # 输出 True，因为 True 是 Truthy 值
